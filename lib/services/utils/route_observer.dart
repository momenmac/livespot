...
class AppRouteObserver extends NavigatorObserver {
  ...
  void _updateRoute(Route<dynamic>? route) {
    ...
    if (route?.settings.name != null) {
      ...
      developer.log(
          'NAV OBSERVER: Encountered route without a name: ${route.runtimeType}',
          name: 'RouteObserver');
