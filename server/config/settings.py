...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '192.168.1.38', '192.168.1.x']
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '10.0.0.3', '192.168.1.x', '10.0.0.3','192.168.1.38']  # Added your IP for mobile testing
