...
\begin{figure}[!htbp]
    ...
    \caption{Account Creation Flow on Android---Dark Theme Implementation}
    \label{fig:android_account_creation}
\end{figure}
...
\begin{figure}[!htbp]
    ...
    \subfigure[Reset Request]{
        \includegraphics[width=0.45\textwidth]{figures/ui/forget_password.jpeg}
    }
    \hspace{0.05\textwidth}
    \subfigure[Verification Code]{
        \includegraphics[width=0.45\textwidth]{figures/ui/forget_password_verify_android.jpeg}
    }
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/ui/home_wb.png}
